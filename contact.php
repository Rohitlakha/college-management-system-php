...
<section class="contact-us">
    ...
    <div class="contact-col">
           ...
           <form action="contact-insert.php" method="post">
            ...
            <input type="text" name="subject1" placeholder="Enter Your subject" required>
            <textarea type="text" rows="8" name="message1" placeholder="Message" required></textarea>
            <input type="submit" class="hero-btn red-btn" value="Send Message">
           </form>
