...
<div class="container mt-5 my-5">
    <center><h2>Manage Connect Details</h2></center>
    <?php
    ...
    <table class="table table-bordered mt-3" style="text-align: center;">
      <thead>
        <tr>
          ...
          <th style="background-color: #333; color: #fff;">Subject</th>
          <th style="background-color: #333; color: #fff;">Message</th>
      ...
      ?>
        <tr>
            ...
            <td>
            <button type="button" class="btn btn-success"><a style="text-decoration: none; color: white;" href='edit-contact.php?id=<?php echo $row['id']; ?>'>Edit</a>
            <button type="button" class="btn btn-danger"><a style="text-decoration: none; color: white;" href='delete-contact.php?id=<?php echo $row['id']; ?>'>Delete</a>
